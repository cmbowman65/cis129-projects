...
# This code determines the percent of increase in sales
...
# This code prints the store and employee bonus information
print("The store bonus amount is $", storeAmount)
print("The employee bonus amount is $", empAmount)

# This code prints a statement if both maximum bonuses are met 
